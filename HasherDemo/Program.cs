...
namespace HasherDemoTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            md5Hash = hasher.MD5SaltComputeHash(stringToHash);
            Console.WriteLine(md5Hash);
            Console.WriteLine(md5Hash.Length);
            Console.WriteLine(hasher.MD5SaltVerifyHash(stringToHash, md5Hash));
            ...
            sha256Hash = hasher.SHA256SaltComputeHash(stringToHash);
            Console.WriteLine(sha256Hash);
            Console.WriteLine(sha256Hash.Length);
            Console.WriteLine(hasher.SHA256SaltVerifyHash(stringToHash, sha256Hash));
            ...
            sha512Hash = hasher.SHA512SaltComputeHash(stringToHash);
            Console.WriteLine(sha512Hash);
            Console.WriteLine(sha512Hash.Length);
            Console.WriteLine(hasher.SHA512SaltVerifyHash(stringToHash, sha512Hash));
